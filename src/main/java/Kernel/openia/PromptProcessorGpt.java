...
public class PromptProcessorGpt {
    ...
    public String buildPrompt() {
        return new StringBuilder("Dado el siguiente texto de un pedido:")
                .append(this.block)
                .append("Realiza las siguientes transformaciones:")
                .append("1. Elimina la línea que contiene Dirección exacta.")
                .append("2. Si la línea Dirección exacta tiene información redundante, crea una nueva línea con la etiqueta Referencia: seguida ")
    ...
    public String getResponse() {
        try {
            ...
            String response = openAIClient.createCompletion(model, this.getPromt());
